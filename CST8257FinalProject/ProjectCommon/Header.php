<html>
    <head>
        <meta charset="UTF-8">
        <title>CST8257 Project</title>
        <meta charset="utf-8"> 
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link href="Contents/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
        <link href="Contents/AlgCss/Site.css" rel="stylesheet" type="text/css"/>
        <link href="Contents/AlgCss/Style.css" rel="stylesheet" type="text/css"/>
    </head>
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="padding: 10px" href="http://www.algonquincollege.com">
                <img src="Contents/img/AC.png" 
                   alt="Algonquin College" style="max-width:100%; max-height:100%;"/></a>    
        </div>
